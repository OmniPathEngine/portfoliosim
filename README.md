...
* [Backend & Architecture Reference (DE) - SDE Math & Engine Mechanics](Backend_Documentation_DE.txt)
* [Backend & Architecture Reference (EN) - SDE Math & Engine Mechanics](Backend_Documentation_EN.txt)
* [Frontend UI/UX Reference (DE) - State Handling & Interaction Flow](Frontend_Documentation_DE.txt)
* [Frontend UI/UX Reference (EN) - State Handling & Interaction Flow](Frontend_Documentation_EN.txt)
